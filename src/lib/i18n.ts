...
const translations = {
  ...
  "soh.title": { hu: "Akkumulátor állapot (SoH)", en: "Battery Health (SoH)" },
  "soh.score": { hu: "Állapot", en: "Health" },
  "soh.capacityRetention": { hu: "Kapacitás megtartás", en: "Capacity retention" },
  "soh.internalResistance": { hu: "Belső ellenállás", en: "Internal resistance" },
  "soh.cellAge": { hu: "Cella kora", en: "Cell age" },
  "soh.capacityTrend": { hu: "Kapacitás trend", en: "Capacity trend" },
  "soh.months": { hu: "hónap", en: "months" },
  "soh.years": { hu: "év", en: "years" },
  "soh.excellent": { hu: "Kiváló", en: "Excellent" },
  "soh.good": { hu: "Jó", en: "Good" },
  "soh.fair": { hu: "Elfogadható", en: "Fair" },
  "soh.poor": { hu: "Gyenge", en: "Poor" },
  "soh.critical": { hu: "Kritikus", en: "Critical" },
  "soh.factors": { hu: "Összetevők", en: "Factors" },
